...
public class unaDym {
    ...
    //array de 5 alumnos de manera estatica
    ...
    public static void pedirNombres(){
        for (int i=0; i<unaDym.ALUMNOS; i++){
            System.out.print("Nombre Alumno" + i + ": ");
            unaDym.alumnos[i] = unaDym.entrada.next();
    ...
    public static void generarNotas(){
        ...
        max = notas[0];
        min = notas[0];
        //sip se alcanzan en la posicion
    ...
    public static void notasTeclado(){
        ...
        for (int i = 0; i<ALUMNOS; i++){ //0..5 indice del for
            ...
            notas[i] = unaDym.entrada.nextInt();
        }
        System.out.println("----- Impresion de Notas ------");
        for (int i = 0; i<ALUMNOS; i++){
            System.out.print("nota de " + alumnos [i] + " : " + notas[i]);
        }
